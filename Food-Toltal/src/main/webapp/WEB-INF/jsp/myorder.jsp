...
<head>
    ...
    <script type="text/javascript">
        ...
        //删除
        function Delete(id) {
            $.post("/Order/Delete.do",{id:id},function (data) {
                if (data.bool==true){
                    alert(data.message);
            ...
            <tr class="warning">
                <th colspan="4">
                   订单编号:${order.orderId}&nbsp; &nbsp;
                    ...
                    状态：<c:if test="${order.orderstatus==0}">未预定&nbsp;&nbsp;<a href="javascript:void(0);" onclick="Yu(${order.id})">去预定</a></c:if>
                    <c:if test="${order.orderstatus==1}">已预定 </c:if>
