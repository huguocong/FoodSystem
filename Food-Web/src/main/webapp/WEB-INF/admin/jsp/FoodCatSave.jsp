...
<head>
    ...
    <script type="text/javascript">
        function save() {
            var url="/AdminFoodCat/Save.do";
            var ids=$("#id").val();
            if (ids!=""){
                url="/AdminFoodCat/Updata.do";
            }
            var forObjext={};
            var fs=$("#foodtypeform").serializeArray();
            ...
            <div class="ItemBlock">
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
                            <td><input type="hidden" id="id" name="id"  value="${foodcatinput.id}"/></td>
                        </tr>
                        <tr>
                            <td><input type="hidden" id="parentid" name="parentId" value="${foodcatparenidinput}"/></td>
                        </tr>
                        <tr>
                            <td width="80px">类目</td>
                            <td><input type="text" id="typename" name="name" class="InputStyle" value="${foodcatinput.name}"/>*</td>
                        </tr>
                    </table>
                </div>
            </div>
